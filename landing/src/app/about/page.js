      ...
      <main>
        <section className="relative pt-24 pb-12 sm:pt-32 sm:pb-16 bg-white bg-grid-pattern overflow-hidden">
          ...
          <div className="max-w-[46rem] mx-auto px-5 sm:px-6 text-center space-y-6">
            ...
            <p className="load-in text-slate-500 text-base sm:text-lg leading-[1.65] max-w-[55ch] mx-auto" style={{ "--reveal-delay": "100ms" }}>
            ...
            <p className="load-in text-slate-500 text-base sm:text-lg leading-[1.65] max-w-[55ch] mx-auto" style={{ "--reveal-delay": "160ms" }}>
